...
create table pending_messages(from_username varchar, to_username varchar, message_content varchar, message_id varchar, time_stamp varchar, primary key (from_username, to_username, message_id));
