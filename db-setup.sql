...
create table pending_messages(from_username varchar, to_username varchar, message_content integer[], message_id varchar, primary key (from_username, to_username, message_id));
